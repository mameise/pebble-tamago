...
// Unpack a P-register byte into the six flags.
...
uint8_t tamago_cpu_step(void)
{
  ...
  switch (opcode) {
    ...
    // --- Branches ---
    case 0x10: BRANCH(!s_flag_n); break;  // BPL
    case 0x30: BRANCH( s_flag_n); break;  // BMI
    ...
    case 0xD0: BRANCH(!s_flag_z); break;  // BNE
    case 0xF0: BRANCH( s_flag_z); break;  // BEQ
